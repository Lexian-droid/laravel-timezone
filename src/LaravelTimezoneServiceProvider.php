...
namespace Lexiandev\LaravelTimezone;

use Illuminate\Foundation\AliasLoader;
use Illuminate\Support\Facades\Blade;
use Illuminate\Support\Facades\Event;
use Illuminate\Support\ServiceProvider;
use Lexiandev\LaravelTimezone\Listeners\Auth\UpdateUsersTimezone;
...
class LaravelTimezoneServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        AliasLoader::getInstance()->alias('Timezone', \Lexiandev\LaravelTimezone\Facades\Timezone::class);
